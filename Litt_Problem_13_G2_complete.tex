...
The simple perverse sheaf $K$ is primitive in the sense of
...
The seven-dimensional possibilities follow directly from the Weyl dimension formula (compare the standard tables in
...
This appendix records the explicit calculations that remain useful in
\cref{sec:pair-splitting}.  The splitting of the factor-ordering cover is
proved intrinsically in \cref{lem:off-curve-norm,prop:ordering-cover} and
requires no large coefficient expansion.  What remains here is deliberately
limited to the normalized conic coefficients used for the simple structural
factor, the finite-field irreducibility check for the residual octic, and one
admissible specialization.  Every finite-field reduction used below is
...
\subsection*{A.2. Geometric integrality of the residual octic}
...
\subsection*{A.3. An admissible specialization}
