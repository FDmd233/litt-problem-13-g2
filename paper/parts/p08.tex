\begin{proof}
Appendix~\ref{app:exact-norm} writes $F$, $\Delta$, $A_{\mathrm c}$, and
$B_{\mathrm c}$ in the present coordinates.  Section A.2 records
the seven coefficient identities whose sum is exactly
\eqref{eq:norm-square-identity}.  This is the only algebraic check needed
in the square-class argument.
