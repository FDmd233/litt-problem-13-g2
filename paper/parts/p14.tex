...
For convenience, we record the short highest-weight list rather than leave
...
\end{array}
\]
No other simple type has an irreducible module of dimension seven.
Faithfulness therefore leaves exactly $PGL_2$ on $\Sym^6(\CC^2)$, $SO_7$
on its standard module, and $G_2$ on $V_7$.  For $SO_7$, the exterior
