...
\begin{proof}
A convenient characteristic-$13$ specialization on the normalized chart is
\[
...
We also check the only canonical-model point needed in this specialization.
Since $\mathbf F_{13}$ contains the cube roots of unity and $2,3$ are
invertible, the four canonical forms from \cref{prop:theta-resolution}
remain regular.  The nine quadratic representatives other than
