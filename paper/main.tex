...
\begin{equation}\label{eq:euler-chain}
...
\begin{equation}\label{eq:singular-locus}
 \Sing(X)=\{0\}.
\end{equation}
...
\begin{equation}\label{eq:chi-seven}
 \chi(\IC_X)=7.
\end{equation}
...
\begin{equation}\label{eq:gauss-degree}
...
\begin{equation}\label{eq:surface-invariants}
...
\begin{proposition}\label{prop:hodge-vector}
...
\begin{equation}\label{eq:cyclic-norm}
...
\begin{equation}\label{eq:norm-square-identity}
 F=A^2+3\Delta B^2.
\end{equation}
...
\begin{equation}\label{eq:split-norm-zero}
...
\begin{equation}\label{eq:relative-zero-sum}
 Z(s)=D+D_1+D_2
\end{equation}
...
\begin{equation}\label{eq:total-alt-rank}
 \dim\cH^{-2}(L*L)_{-,t}=2.
\end{equation}
...
\begin{equation}\label{eq:principal-alt-rank}
 \dim\cH^{-2}(K*K)_{-,t}=1.
\end{equation}
...
\begin{equation}\label{eq:generic-alt-vanishing}
 \cH^{-2}(K*K)_-=0
...
\begin{equation}\label{eq:connected-irreducible}
